...
content = DATA.read
sorter = RucksacksSorter.from_data(content)      # for the Ractor-rich approach
ITEMS_VALUES = ("a".."z").to_a + ("A".."Z").to_a # for the Ractor-less approach

require "benchmark"

Benchmark.bm(20) do |x|
  x.report("part 1, w/ ractors") { sorter.misplaced_items_priorities_sum }
  x.report("part 1, w/o ractors") do 
    content.split("\n")
  ...
  x.report("part 2, w/ ractors") { sorter.badges_priorities_sum }
  x.report("part 2, w/o ractors") do 
    content.split("\n")
           .each_slice(3).to_a
